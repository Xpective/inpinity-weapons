...
Diese Datei dokumentiert die wichtigsten Read-Funktionen der live laufenden Base-Mainnet-City-Contracts, damit Offchain-Daten immer gegen die echte Onchain-Quelle geprüft werden können.
